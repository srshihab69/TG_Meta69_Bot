...
async function handleMediaPayload(chatId, mediaData) {
    if (mediaData) {
        ...
        const headerText = `<blockquote>👤 <b>Generated By:</b> ${userLinkHtml}</blockquote>\n` +
                           `<blockquote>🆔 ID: <code>${generatorId}</code></blockquote>\n` +
                           `<blockquote>🏷️ Username: ${generatorUsername}</blockquote>\n`;
    ...
    try {
        ...
        if (text === '/user') {
            ...
            await bot.sendMessage(chatId, `<blockquote>🆔 <b>Your Information</b></blockquote>\n` +
                `<blockquote>🆔 ID: <code>${u.id}</code></blockquote>\n` +
                `<blockquote>👤 Name: <code>${u.first_name}</code> | Tag: @${u.username || 'N/A'}</blockquote>`, { 
                parse_mode: 'HTML',
                reply_markup: hideKeyboard
            });
        }
            ...
            await bot.sendMessage(chatId, `<blockquote>🛡️ <b>Need help or found a bug?</b></blockquote>\n` +
                `<blockquote>If you encounter any issues, have questions, or want to suggest a new feature, feel free to reach out!</blockquote>\n` +
            ...
            await bot.sendMessage(chatId, 
                ...
                `<blockquote>├─ 🤖 This bot supports only links generated by the bot itself:\n├─ 🔗 Direct Media Links\n└─ 🔗 Shared Media Links</blockquote>\n` +
                `<blockquote>⚠️ Please use a Direct or Share Link.</blockquote>`, 
            ...
            try {
                ...
                const info = `<blockquote>🔍 <b>Shared User Info</b></blockquote>\n` +
                    `<blockquote>🆔 ID: <code>${user.id}</code></blockquote>\n` +
                    `<blockquote>👤 Name: <code>${user.first_name} ${user.last_name || ''}</code></blockquote>\n` +
                    `<blockquote>🏷️ User: @${user.username || 'None'} | Prem: ${user.is_premium ? '✅' : '❌'}</blockquote>`;
                ...
                await bot.sendMessage(chatId, `<blockquote>🔍 <b>Shared User Info</b></blockquote>\n` +
                    `<blockquote>🆔 ID: <code>${userId}</code></blockquote>\n` +
                    `<blockquote>⚠️ Details restricted.</blockquote>`, {
                    parse_mode: 'HTML',
                    reply_markup: hideKeyboard
                });
            }
        ...
        // ================= HIGH FILTERED TIKTOK HANDLER (30MB LIMIT + 3 BLOCKQUOTES) =================
                ...
                if (videoDownloadUrl) {
                    ...
                    if (sizeInMB <= 30) {
                        ...
                        await bot.sendMessage(chatId, 
                            ...
                            `<blockquote>📊 File Size: <code>${sizeInMB.toFixed(2)} MB</code></blockquote>\n` +
                            `<blockquote>🔗 Click the button below to download the video directly from the browser. ✅</blockquote>`, 
                            { 
                                parse_mode: 'HTML',
                                reply_markup: {
                                    inline_keyboard: [
                    ...
                    await bot.sendMessage(chatId, `<blockquote>⚠️ <b>This link is not supported.</b></blockquote>\n` + `<blockquote>🔗 <b>Please send a valid link and try again.</b> ✅</blockquote>`, { 
                        parse_mode: 'HTML',
                        reply_markup: hideKeyboard
                    });
                    return;
        ...
        // ==============================================================================
            ...
            if (msg.forward_from || msg.forward_from_chat || msg.forward_origin) {
                ...
                finalMessage += `<blockquote>📩 <b>Forwarded Message</b></blockquote>\n` +
                    `<blockquote>🆔 Source ID: <code>${fId}</code></blockquote>\n` +
                    `<blockquote>👤 Name: <code>${fName}</code></blockquote>\n`;
            }
            ...
            if (msg.photo || msg.video || msg.animation || msg.sticker || msg.document || msg.audio || msg.voice) {
                ...
                finalMessage += `<blockquote>✨ <b>${mType}</b></blockquote>\n` +
                    ...
                    `<blockquote>🔗 Direct Link : <code>${browserDirectLink}</code></blockquote>\n`;
